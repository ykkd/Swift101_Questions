...
/*
 ...
 さらに、Bool型の計算型プロパティ「isRed」を定義してください。「isRed」は赤い色の果物の場合のみ、trueを、その他の場合はfalseを返してください。
 */

/*
 定数「apple」に列挙型Fruitのインスタンス case appleを代入してください。
 appleが赤い色の果物である場合は、「赤い色の果物です」と、そうではない場合は「赤い色の果物ではありません」と出力してください
 */


/*
 方角を表現した列挙型「Direction」を定義し、その中に「north」「south」「east」「west」というケースを追加してください。
 ただし、northは1,westは4になるようにrawValueを設定してください。
